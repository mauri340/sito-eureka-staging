(function () {
  ...
  // WhatsApp Business contact details (override via window.WHATSAPP_WIDGET_CONFIG)
  var cfg = window.WHATSAPP_WIDGET_CONFIG || {};
  var WHATSAPP_NUMBER = cfg.number || '390240702168';
  var WHATSAPP_MESSAGE = cfg.message || '';
  var WHATSAPP_TOOLTIP = cfg.tooltip || 'Contattaci su WhatsApp';
  var WHATSAPP_BOTTOM = cfg.bottom || '';
  ...
  // HTML structure
  var html = `
  <a id="whatsapp-widget" href="${WHATSAPP_URL}" data-tooltip="${WHATSAPP_TOOLTIP.replace(/"/g, '&quot;')}" target="_blank" rel="noopener noreferrer" aria-label="Contatta su WhatsApp Business">
  ...
  function injectWhatsAppWidget() {
    ...
    if (widget) {
      if (WHATSAPP_BOTTOM) {
        widget.style.setProperty('bottom', WHATSAPP_BOTTOM, 'important');
      }
